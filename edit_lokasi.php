                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    $lokasi = ambil_lokasi_by_id($location_id);

                                    if ($lokasi) {
                                    ?>
                                    <form action="process_edit_lokasi.php" method="POST">
                                        <input type="hidden" name="location_id" value="<?= htmlspecialchars($lokasi['location_id']) ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="alamat_lokasi" name="alamat_lokasi" rows="4" required><?= htmlspecialchars($lokasi['alamat_lokasi']) ?></textarea>
                                        </div>
